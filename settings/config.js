module.exports = {
  TOKEN:
    process.env.TOKEN || "OTI5NjY4NzU1MzU5OTU3MDUy.GujeB3.zBvm-6wg_MOh9EI9tebbdhG7M12OGZS8Lxidy0",
  PREFIX: process.env.PREFIX || "+",
  embed: {
    color: process.env.color || "#0x6ab8c6",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "PC & Electronics Basics",
    footericon: "https://cdn.pe-basics.com/media/90db9da4fc5414ab55a9fe495d555c06.png",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
