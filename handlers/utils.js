...
module.exports = async (client) => {
  ...
  client.queueembed = (guild) => {
    let embed = new MessageEmbed()
      ...
      .setThumbnail("https://cdn.pe-basics.com/media/90db9da4fc5414ab55a9fe495d555c06.png")
      .setFooter({
        text: guild.name,
        iconURL: guild.iconURL({ dynamic: true }),
      });
  ...
  client.playembed = (guild) => {
    let embed = new MessageEmbed()
      ...
      .setDescription(
        ` [Invite Now](${client.config.links.inviteURL}) • [Support Server](${client.config.links.DiscordServer}) • [Website](${client.config.links.WebsiteURL})`
      )
      .setImage(
        guild.banner
          ? guild.bannerURL({ size: 4096 })
          : `https://cdn.pe-basics.com/media/8613985ec49eb8f757ae6439e879bb2a.png`
      )
      .setFooter({
        text: guild.name,
        iconURL: guild.iconURL({ dynamic: true }),
